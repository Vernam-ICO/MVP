...
public class PaymentCreateViewModel implements Serializable {
    ...
    private UserPaymentModel user;

    private Long tokens;

    public PaymentCreateViewModel() {
    }
    ...
    public UserPaymentModel getUser() {
        return this.user;
    }

    public void setUser(final UserPaymentModel user) {
        this.user = user;
    }
